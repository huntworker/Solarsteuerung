...
/**
 * @brief STM32F37x Standard Peripherals Library version number V0.1.0RC1
   */
#define __STM32F37X_STDPERIPH_VERSION_MAIN   (0x00) /*!< [31:24] main version */
#define __STM32F37X_STDPERIPH_VERSION_SUB1   (0x01) /*!< [23:16] sub1 version */
...
#define  DBGMCU_APB1_FZ_DBG_TIM19_STOP       ((uint32_t)0x00000020)
